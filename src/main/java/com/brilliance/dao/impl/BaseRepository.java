...
//    }
//
//    public List<T> findBySql(String sql,Class c) {
//        SQLQuery navtiveSQL = this.openSession().createSQLQuery(sql);
//        navtiveSQL.addEntity(c);
//        List<T>  list= navtiveSQL.list();
//        return list;
//    }
//
//    public T findBySql(String sql,T o) {
//        Session session = this.openSession();
//        T t = (T)session.createSQLQuery(sql).addEntity(o.getClass()).uniqueResult();
//        session.flush();
//        session.clear();
//        return t;
//    }
...
//        rows = rows > 0 ? rows : 10;
//
//        return q.setFirstResult((page > 0 ? (page - 1) : 0) * rows).setMaxResults(rows).list();
//    }
//
//    public List<T> find(String hql, Map<String, Object> param, Integer page,
//                        Integer rows) {
...
//    }
//
//    public Long count1(String hql, Map<String, Object> param) {
//        String listSize="0";
//        try{
//            Query q = this.openSession().createQuery(hql);
//            if (param != null && param.size() > 0) {
...
//                }
//            }
//            listSize=((Number)q.uniqueResult()).intValue()+"";//q.list().size()+"";
//
//        }catch (Exception e){
//            e.printStackTrace();
//        }
...
//    }
//
//    public Object executeSqlString(String sql) {
//        SQLQuery sq = this.openSession().createSQLQuery(sql).addScalar("str",StandardBasicTypes.STRING) ;
